...
<template>
  <div class="nc-all-tables-view">
    ...
    <template v-else-if="activeTables.length">
      <div class="flex flex-row w-full text-gray-700 border-b-1 border-gray-50 bg-gray-50 py-3 px-2.5">
      ...
      >
        <div
          ...
          :key="table.id"
          class="py-4 flex flex-row w-full cursor-pointer hover:bg-gray-50/50 border-b-1 border-gray-100 px-2.25"
...
.nc-base-view-all-table-btn {
  @apply flex-none flex flex-col gap-y-3 px-3 py-5 bg-gray-50 rounded-xl border-1 border-gray-100 min-w-[230px] max-w-[248px] cursor-pointer text-gray-800 hover:(bg-gray-100 border-gray-200) transition-all duration-300;
  &:hover {
